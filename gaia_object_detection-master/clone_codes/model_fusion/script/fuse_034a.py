...
with open('../../../tfobjdetect/results/det_results_m18_jpg_oi_1_filtered.pkl', 'rb') as fin:
    det_results_oi = pickle.load(fin)

with open('../../../tfobjdetect/results/det_results_m18_jpg_coco_1_filtered.pkl', 'rb') as fin:
    det_results_coco = pickle.load(fin)

with open('../../../wsod/results/det_results_dpl_034a.pkl', 'rb') as fin:
