...
### absolute
MODEL_NAME = '/root/src/tfobjdetect/checkpoints/faster_rcnn_inception_resnet_v2_atrous_oid'
...
### absolute
PATH_TO_LABELS = os.path.join('/root/src/tf/models/research/object_detection/data', 'oid_bbox_trainable_label_map.pbtxt')
